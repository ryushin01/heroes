 ...
 * @summary 00: 지급 정보 등록                  상환금 요청하기 버튼 노출
 *          01: 지급 처리 중(요청 상태)          상환금 요청하기 버튼 비활성화
 *          02: 지급 완료                      상환영수증 등록 버튼 노출
 *          03: 상환금 영수증 처리 중(관리자)     상환영수증 확인 중 노출
 *          04: 상환금 영수증 전송 중            상환영수증 확인 중 노출
 *          05: 상환금 영수증 반려 (관리자)       반려 및 상환영수증 재등록 버튼 노출
 *          10: 상환금 영수증 처리 완료
 *          91: 지급 요청 실패
 *          92: 지급 결과 실패
 *          93: 이미지 전송 실패
