...
export default function MyCaseDetail({
  ...
  const [b200ErrorCode, setB200ErrorCode] = useState("");
      ...
      fetchApi({
        ...
        .then((res) => {
          if (res.code === "99") {
            ...
            setB200ErrorCode(res.data?.statCd);
            openB200Error();
            return null;
          } else {
            return res.data;
      ...
      <main className="bg-kos-gray-100 w-full h-full flex flex-col border-box">
        ...
        >
          ...
          <Alert
            ...
            title={
              b200ErrorCode === "999" || b200ErrorCode === "B01"
                ? "요청 시간이 초과되었습니다"
                : "대출 정보 요청에 실패했습니다"
            }
            bodyText={
              b200ErrorCode === "999" || b200ErrorCode === "B01"
                ...
                : `[실패코드:${b200ErrorCode}] 고객센터(1877-2495)에 문의해주세요.`
            }
            confirmText={"확인"}
            confirmCallBack={() => {
              //내사건 목록으로 이동
